...
if answer=="left":
    ...
    answer=input("You come to a bridge, it looks wobbly, do u want to cross it or head back (cross/back)? ").lower()
    if answer=="cross":
        answer=input("You cross the bridge and meet a stranger. Do u talk to him (yes/no)? ").lower()
        if answer=="yes":
